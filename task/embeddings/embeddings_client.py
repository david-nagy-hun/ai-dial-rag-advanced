...
class DialEmbeddingsClient:
    ...
    def get_embeddings(self, inputs: str | list[str], dimensions: int, print_request: bool = True,
                       print_response: bool = False) -> dict[int, list[float]]:
        """
    ...
    @staticmethod
    def _from_data(data: list[dict]) -> dict[int, list[float]]:
